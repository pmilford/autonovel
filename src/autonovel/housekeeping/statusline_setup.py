...
DEFAULT_ALLOW = [
    ...
    "Bash(autonovel _end:*)",
    "Bash(autonovel _tail-chapter:*)",
    "Bash(autonovel mechanical:*)",
    "Bash(autonovel mechanical slop:*)",
    "Bash(autonovel mechanical period-bans:*)",
    "Bash(autonovel mechanical apply-cuts:*)",
    "Bash(autonovel mechanical spine-width:*)",
    "Bash(autonovel mechanical audio-validate:*)",
